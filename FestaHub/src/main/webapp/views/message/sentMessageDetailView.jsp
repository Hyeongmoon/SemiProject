    ...
    <div id="board-outer">
        ...
        <div >
            <div style="float: right;">
                ...
                <span>받는 사람 : <%= msg.getUserNickname() %></span>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
        ...
        <div class="list-body">
                ...
                <table id="board-table" class="table table-hover" >
                    <tbody>
                        ...
                        <tr>
                            <td>
                                이전글 : 
                                <a href="<%= contextPath %>/detail.sme?nsme=<%= prevMsg.getMsgNo() %>"
                    ...
                    <% if(nextMsg != null) { %>    
                        <tr>
                            <td>
                                다음글 : 
                                <a href="<%= contextPath %>/detail.sme?nsme=<%= nextMsg.getMsgNo() %>"
                                   style="text-decoration: none; color: black;">
            ...
            <div class="button-area">
                <div align="right">
                <% if((loginUser != null) 
					&& (loginUser.getUserNo() == msg.getSenderNo())) { %>
                    <button onclick="location.href='<%= contextPath %>/delete.sme?nsme=<%= msg.getMsgNo() %>'"
                            class="btn btn-sm btn-secondary">
                    	삭제
                    </button>
                <% } %>
                    <button onclick="location.href='<%= contextPath %>/list.sme?currentPage=1'"
                            class="btn btn-sm btn-secondary">
					    목록
					</button>
                </div>
