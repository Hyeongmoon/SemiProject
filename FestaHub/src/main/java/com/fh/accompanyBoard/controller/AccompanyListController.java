...
/**
 * Servlet implementation class AccompanyListController
 */
@WebServlet("/list.ac")
public class AccompanyListController extends HttpServlet {
     ...
     */
    public AccompanyListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 동행구하기 리스트 조회 페이지에 포워딩
		request.getRequestDispatcher("views/accompanyBoard/accompanyListView.jsp")
