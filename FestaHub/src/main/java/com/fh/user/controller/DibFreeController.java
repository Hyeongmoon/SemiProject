 ...
 */
@WebServlet("/dibfree.fh")
public class DibFreeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DibFreeController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new UserService().selectDibFreeCount(userNo);				//총 게시글 수
		currentPage 
		...
		request.getRequestDispatcher("views/user/dibFree.jsp").forward(request, response);
	}
