...
/**
 * Servlet implementation class AdminAccompanyDetailController
 */
@WebServlet("/views/adminTool/adminDetail.ac")
public class AdminAccompanyDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminAccompanyDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) { // 조회수 증가에 성공했을 경우
			...
			request.getRequestDispatcher("adminAccompanyDetailView.jsp").forward(request, response);
