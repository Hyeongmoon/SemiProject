                ...
                <nav>
                    <ul class="pagination justify-content-center">
                        ...
                        <% if(currentPage > pageLimit) { %>
	                        <li class="page-item">
	                            <a class="page-link" 
	                               href="<%= contextPath %>/list.rme?currentPage=1">
	                            	&lt;&lt;
	                            </a>
	                        </li>
	                        <li class="page-item">
	                            <a class="page-link" href="<%= contextPath %>/list.rme?currentPage=<%= (startPage - 1) %>">
	                            	&lt;
	                            </a>
	                        </li>
                        <% } %>
                        ...
                        <% for(int p = startPage; p <= endPage; p++) { %>
                        	...
                        	<% if(p != currentPage ) { %>
                        		<li class="page-item">
                        			<a class="page-link" href="<%= contextPath %>/list.rme?currentPage=<%= p %>">
                        				<%= p %>
                        			</a>
                        		</li>
                        	<% } else { %>
                        ...
                        <% if(currentPage < maxPage && endPage < maxPage) { %>
	                        <li class="page-item">
	                            <a class="page-link" 
	                               href="<%= contextPath %>/list.rme?currentPage=<%= (endPage + 1) %>">
	                            	&gt;
	                            </a>
	                        </li>
	                        <li class="page-item">
	                            <a class="page-link" 
	                               href="<%= contextPath %>/list.rme?currentPage=<%= maxPage %>">
	                            	&gt;&gt;
	                            </a>
	                        </li>
	                    <% } %>
	...
	<script>
		$(function() {
			...
			$("#board-table>tbody>tr").click(function() {
		        ...
		        let nrme = $(this).find('input[name="msgNo"]').val(); 
		        location.href = "<%= contextPath %>/detail.rme?nrme=" + nrme;
