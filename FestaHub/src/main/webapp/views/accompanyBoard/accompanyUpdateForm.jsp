...
<body>
    ...
    <div id="container-fluid">
        ...
        <div class="list-body">
            ...
            <!-- 바디부분 -->
            <form id="update-form" 
                  action="<%= contextPath %>/update.ac" method="post">
                <input type="hidden" name="nac" value="<%= ac.getAccomNo() %>">
                                ...
                                <div class="body" align="center">
                                    ...
                                    <div class="insert-area">
                                            ...
                                            <div class="free-title">
                                                <input type="text" value="<%= ac.getAccomTitle() %>" 
                                                       name="accomTitle" width="100%">
                                            </div>
                                            
                                            <div class="free-content">
                                                <textarea name="accomContent" 
                                                          id=""><%= ac.getAccomContent() %></textarea>
                                            </div>
                ...
                <div align="right">
                    ...
                    <button type="button"
							class="btn btn-sm btn-secondary"
                    		onclick="location.href='<%= contextPath %>/detail.ac?nac=<%= ac.getAccomNo() %>'">
                    	취소
                    </button>
                    <button type="button"
						    class="btn btn-sm btn-secondary"
                    		onclick="location.href='<%= contextPath %>/list.ac?currentPage=<%= currentPage %>'">
                    	목록
                    </button>
                </div>
            </form>
