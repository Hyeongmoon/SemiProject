...
<%
	...
	int currentPage = (session.getAttribute("acCurrentPage") != null) 
						? (int)session.getAttribute("acCurrentPage") 
						: 1;
%>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div id="container-fluid">
        ...
        <div class="list-body">
            ...
            <form id="enroll-form" 
                  action="<%= contextPath %>/RvInsert.fh" method="post">
            <!-- 작성자의 유저넘버 넘기기 -->
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="insert-area">
                                    <div class="title">
                                        <input type="text" name="rvTitle" 
                                               placeholder="제목을 입력하세요" 
                                               width="100%" required>
                                    </div>
                                    
                                    <div class="content">
                                        <textarea name="rvContent" id="" 
